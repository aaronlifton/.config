local opts_extend = require("config.abstract.utils").opts_extend
local M = {}
...
function M.ctrl_backspace_delete(opts)
  ...
  if opts.insert_mode then vim.api.nvim_set_keymap("i", "<C-BS>", "<C-w>", { noremap = true }) end
  if opts.cmd_mode then vim.api.nvim_set_keymap("c", "<C-BS>", "<C-w>", { noremap = true }) end
end
