...
const float BRIGHT_CUTOFF = 0.25;        // Threshold for what's considered a bright pixel
const float BRIGHT_BOOST = 5.0;          // Brightness multiplier for bright pixels (default: 1.2)
const float DIM_GLOW = 0.05;             // Glow intensity for dim pixels (default: 0.05)
const float BRIGHT_GLOW = 0.90;          // Glow intensity for bright pixels (default: 0.10)
const float COLOR_GLOW = 0.7;            // Color bleeding intensity (default: 0.3)
...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
    ...
    fratColor = vec4(with_scanline, final_alpha);
/// ft
