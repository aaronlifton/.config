...
complete -c fd -s c -l color -d 'When to use colors' -r -f -a "{auto    show colors if the output goes to an interactive console (default),always       always use colorized output,neverdo not use colorized output}"
