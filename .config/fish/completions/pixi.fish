...
complete -c pixi -n "__fish_pixi_using_subcommand help; and not __fish_seen_subcommand_from add auth build clean completion config exec global info init install list lock reinstall remove run search self-update shell shell-hook task tree update upgrade upload workspace help" -f -a add -d 'Adds dependencies to the workspace'
complete -c pixi -n "__fish_pixi_using_subcommand help; and not __fish_seen_subcommand_from add auth build clean completion config exec global info init install list lock reinstall remove run search self-update shell shell-hook task tree update upgrade upload workspace help" -f -a auth -d 'Login to prefix.dev or anaconda.org servers to access private channels'
complete -c pixi -n "__fish_pixi_using_subcommand help; and not __fish_seen_subcommand_from add auth build clean completion config exec global info init install list lock reinstall remove run search self-update shell shell-hook task tree update upgrade upload workspace help" -f -a build -d 'Workspace configuration'
complete -c pixi -n "__fish_pixi_using_subcommand help; and not __fish_seen_subcommand_from add auth build clean completion config exec global info init install list lock reinstall remove run search self-update shell shell-hook task tree update upgrade upload workspace help" -f -a clean -d 'Cleanup the environments'
complete -c pixi -n "__fish_pixi_using_subcommand help; and not __fish_seen_subcommand_from add auth build clean completion config exec global info init install list lock reinstall remove run search self-update shell shell-hook task tree update upgrade upload workspace help" -f -a completion -d 'Generates a completion script for a shell'
complete -c pixi -n "__fish_pixi_using_subcommand help; and not __fish_seen_subcommand_from add auth build clean completion config exec global info init install list lock reinstall remove run search self-update shell shell-hook task tree update upgrade upload workspace help" -f -a config -d 'Configuration management'
complete -c pixi -n "__fish_pixi_using_subcommand help; and not __fish_seen_subcommand_from add auth build clean completion config exec global info init install list lock reinstall remove run search self-update shell shell-hook task tree update upgrade upload workspace help" -f -a exec -d 'Run a command and install it in a temporary environment'
complete -c pixi -n "__fish_pixi_using_subcommand help; and not __fish_seen_subcommand_from add auth build clean completion config exec global info init install list lock reinstall remove run search self-update shell shell-hook task tree update upgrade upload workspace help" -f -a global -d 'Subcommand for global package management actions'
complete -c pixi -n "__fish_pixi_using_subcommand help; and not __fish_seen_subcommand_from add auth build clean completion config exec global info init install list lock reinstall remove run search self-update shell shell-hook task tree update upgrade upload workspace help" -f -a info -d 'Information about the system, workspace and environments for the current machine'
complete -c pixi -n "__fish_pixi_using_subcommand help; and not __fish_seen_subcommand_from add auth build clean completion config exec global info init install list lock reinstall remove run search self-update shell shell-hook task tree update upgrade upload workspace help" -f -a init -d 'Creates a new workspace'
complete -c pixi -n "__fish_pixi_using_subcommand help; and not __fish_seen_subcommand_from add auth build clean completion config exec global info init install list lock reinstall remove run search self-update shell shell-hook task tree update upgrade upload workspace help" -f -a install -d 'Install an environment, both updating the lockfile and installing the environment'
complete -c pixi -n "__fish_pixi_using_subcommand help; and not __fish_seen_subcommand_from add auth build clean completion config exec global info init install list lock reinstall remove run search self-update shell shell-hook task tree update upgrade upload workspace help" -f -a list -d 'List workspace\'s packages'
complete -c pixi -n "__fish_pixi_using_subcommand help; and not __fish_seen_subcommand_from add auth build clean completion config exec global info init install list lock reinstall remove run search self-update shell shell-hook task tree update upgrade upload workspace help" -f -a lock -d 'Solve environment and update the lock file without installing the environments'
complete -c pixi -n "__fish_pixi_using_subcommand help; and not __fish_seen_subcommand_from add auth build clean completion config exec global info init install list lock reinstall remove run search self-update shell shell-hook task tree update upgrade upload workspace help" -f -a reinstall -d 'Re-install an environment, both updating the lockfile and re-installing the environment'
complete -c pixi -n "__fish_pixi_using_subcommand help; and not __fish_seen_subcommand_from add auth build clean completion config exec global info init install list lock reinstall remove run search self-update shell shell-hook task tree update upgrade upload workspace help" -f -a remove -d 'Removes dependencies from the workspace'
complete -c pixi -n "__fish_pixi_using_subcommand help; and not __fish_seen_subcommand_from add auth build clean completion config exec global info init install list lock reinstall remove run search self-update shell shell-hook task tree update upgrade upload workspace help" -f -a run -d 'Runs task in the pixi environment'
complete -c pixi -n "__fish_pixi_using_subcommand help; and not __fish_seen_subcommand_from add auth build clean completion config exec global info init install list lock reinstall remove run search self-update shell shell-hook task tree update upgrade upload workspace help" -f -a search -d 'Search a conda package'
complete -c pixi -n "__fish_pixi_using_subcommand help; and not __fish_seen_subcommand_from add auth build clean completion config exec global info init install list lock reinstall remove run search self-update shell shell-hook task tree update upgrade upload workspace help" -f -a self-update -d 'Update pixi to the latest version or a specific version'
complete -c pixi -n "__fish_pixi_using_subcommand help; and not __fish_seen_subcommand_from add auth build clean completion config exec global info init install list lock reinstall remove run search self-update shell shell-hook task tree update upgrade upload workspace help" -f -a shell -d 'Start a shell in a pixi environment, run `exit` to leave the shell'
complete -c pixi -n "__fish_pixi_using_subcommand help; and not __fish_seen_subcommand_from add auth build clean completion config exec global info init install list lock reinstall remove run search self-update shell shell-hook task tree update upgrade upload workspace help" -f -a shell-hook -d 'Print the pixi environment activation script'
complete -c pixi -n "__fish_pixi_using_subcommand help; and not __fish_seen_subcommand_from add auth build clean completion config exec global info init install list lock reinstall remove run search self-update shell shell-hook task tree update upgrade upload workspace help" -f -a task -d 'Interact with tasks in the workspace'
complete -c pixi -n "__fish_pixi_using_subcommand help; and not __fish_seen_subcommand_from add auth build clean completion config exec global info init install list lock reinstall remove run search self-update shell shell-hook task tree update upgrade upload workspace help" -f -a tree -d 'Show a tree of workspace dependencies'
complete -c pixi -n "__fish_pixi_using_subcommand help; and not __fish_seen_subcommand_from add auth build clean completion config exec global info init install list lock reinstall remove run search self-update shell shell-hook task tree update upgrade upload workspace help" -f -a update -d 'The `update` command checks if there are newer versions of the dependencies and updates the `pixi.lock` file and environments accordingly'
complete -c pixi -n "__fish_pixi_using_subcommand help; and not __fish_seen_subcommand_from add auth build clean completion config exec global info init install list lock reinstall remove run search self-update shell shell-hook task tree update upgrade upload workspace help" -f -a upgrade -d 'Checks if there are newer versions of the dependencies and upgrades them in the lockfile and manifest file'
complete -c pixi -n "__fish_pixi_using_subcommand help; and not __fish_seen_subcommand_from add auth build clean completion config exec global info init install list lock reinstall remove run search self-update shell shell-hook task tree update upgrade upload workspace help" -f -a upload -d 'Upload a conda package'
complete -c pixi -n "__fish_pixi_using_subcommand help; and not __fish_seen_subcommand_from add auth build clean completion config exec global info init install list lock reinstall remove run search self-update shell shell-hook task tree update upgrade upload workspace help" -f -a workspace -d 'Modify the workspace configuration file through the command line'
complete -c pixi -n "__fish_pixi_using_subcommand help; and not __fish_seen_subcommand_from add auth build clean completion config exec global info init install list lock reinstall remove run search self-update shell shell-hook task tree update upgrade upload workspace help" -f -a help -d 'Print this message or the help of the given subcommand(s)'
