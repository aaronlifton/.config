...
H.setup_config = function(config)
  ...
  vim.validate("hinted.chars", config.hinted.chars, function(x)
    return H.is_list_of(x, "hinted.chars", "string")
  end)
  vim.validate("hinted.virt_clues_pos", config.hinted.virt_clues_pos, function(x)
    return H.is_list_of(x, "hinted.virt_text_pos", "string")
  end)
...
H.create_autocommands = function()
  ...
  -- au("User", "MiniPickMatch", H.on_pick_start_event, "Augment pickers with hints")
end
