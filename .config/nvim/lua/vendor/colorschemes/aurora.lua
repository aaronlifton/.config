...
return {
	colorscheme = function() 
		...
		vim.api.nvim_set_hl(0, "GitSignsAddInline", {fg="NONE", bg="NONE", ctermfg="NONE", ctermbg="NONE", sp="#addb67", underline = true, bold= true })
		vim.api.nvim_set_hl(0, "GitSignsDeleteInline", {fg="NONE", bg="NONE", ctermfg="NONE", ctermbg="NONE", sp="#E7C547", undercurl = true, bold= true })
		vim.api.nvim_set_hl(0, "GitSignsChangeInline", {fg="NONE", bg="NONE", ctermfg="NONE", ctermbg="NONE", sp="#B376B3", undercurl = true, bold= true })
		...
		vim.api.nvim_set_hl(0, "ClapMatches", {fg="#C33C4A", bg="#443a54", ctermfg=131, ctermbg=238, sp="#f05874", undercurl = true, reverse= true , bold= true })
		vim.api.nvim_set_hl(0, "ClapDisplay", {fg="#aab7cf", bg=bg, ctermfg=146, ctermbg=234, sp="#f05874", undercurl = true, bold= true })
		...
		vim.api.nvim_set_hl(0, "TSError", {fg="#DC143C", bg="NONE", ctermfg=161, ctermbg="NONE",  undercurl = true, bold= true })
		...
		vim.api.nvim_set_hl(0, "TSEmphasis", {fg="#fbed7d",  ctermfg=228,   undercurl = true, italic= true , bold= true })
		...
		vim.api.nvim_set_hl(0, "LightspeedLabel", {fg="#e7d3fb", bg="#57109a", ctermfg=189, ctermbg=54, sp="#ecc48d", undercurl = true, italic= true , bold= true })
		...
		vim.api.nvim_set_hl(0, "LightspeedShortcut", {fg="#EE82EE",  ctermfg=213,   undercurl = true, bold= true })
		vim.api.nvim_set_hl(0, "LightspeedShortcutOverlapped", {fg="#EE82EE",  ctermfg=213,   undercurl = true, bold= true })
		vim.api.nvim_set_hl(0, "LightspeedMaskedChar", {fg="#ff5874",  ctermfg=204,   undercurl = true, bold= true })
		vim.api.nvim_set_hl(0, "LightspeedGreyWash", {fg="#989cbf",  ctermfg=247,   italic = (vim.g.aurora_italic==1)})
		vim.api.nvim_set_hl(0, "LightspeedUnlabeledMatch", {fg="#F92772",  ctermfg=197,   italic = (vim.g.aurora_italic==1), bold= true })
		vim.api.nvim_set_hl(0, "LightspeedOneCharMatch", {fg="#f19bb6",  ctermfg=211,   italic = (vim.g.aurora_italic==1), bold= true })
		vim.api.nvim_set_hl(0, "LightspeedUniqueChar", {fg="#d7ffaf",  ctermfg=193,   bold = (vim.g.aurora_bold==1)})
		vim.api.nvim_set_hl(0, "LightspeedPendingOpArea", {fg="#66d9ef",  ctermfg=81,   undercurl = true, bold= true })
		...
		vim.api.nvim_set_hl(0, "HopNextKey", {fg="#EE82EE",  ctermfg=213,   underline = true, bold= true })
		vim.api.nvim_set_hl(0, "HopNextKey1", {fg="#ecc48d",  ctermfg=222,   underline = true, bold= true })
		vim.api.nvim_set_hl(0, "HopNextKey2", {fg="#82aaf0",  ctermfg=111,   underline = true, bold= true })
		...
		vim.api.nvim_set_hl(0, "IndentBlanklineContextStart", {fg="#c4a2ff",  ctermfg=183,  sp="#c4a2ff", underline = true, bold= true })
		...
		vim.api.nvim_set_hl(0, "LspReferenceText", { bg="#343047",  ctermbg=239, sp="#FD9720", undercurl = true, bold= true })
		vim.api.nvim_set_hl(0, "LspReferenceRead", {fg="#1aad16",  ctermfg=34,  sp="#FD9720", undercurl = true, bold= true })
		vim.api.nvim_set_hl(0, "LspReferenceWrite", {fg="#1aad16",  ctermfg=34,  sp="#FD9720", undercurl = true, bold= true })
		vim.api.nvim_set_hl(0, "LspFloatWinNormal", {fg="#dacfb4", bg="#30234f", ctermfg=187, ctermbg=236,  })
		vim.api.nvim_set_hl(0, "LspSignatureActiveParameter", {fg="NONE", bg="#4d0c5d", ctermfg="NONE", ctermbg=53, sp="#fbec9f", underline = true, italic= true , bold= true })
		...
		vim.api.nvim_set_hl(0, "goBuiltins", {fg="#01d5f1", bg="NONE", ctermfg=45, ctermbg="NONE",  italic = (vim.g.aurora_italic==1), bold= true })
		...
		vim.api.nvim_set_hl(0, "goSameId", {fg="NONE", bg="#343047", ctermfg="NONE", ctermbg=236,  undercurl = true, italic= true , bold= true })
		...
		vim.api.nvim_set_hl(0, "DiffText", {fg="NONE", bg="#420010", ctermfg="NONE", ctermbg=89,  italic = (vim.g.aurora_italic==1), underline= true , bold= true })
		...
		vim.api.nvim_set_hl(0, "IncSearch", {fg="NONE", bg="#57109a", ctermfg="NONE", ctermbg=54, sp="#ecc48d", undercurl = true, italic= true , bold= true })
		vim.api.nvim_set_hl(0, "MatchParen", {fg="#EE82EE", bg="NONE", ctermfg=213, ctermbg="NONE", sp="#E7C547", undercurl = true, bold= true })
		...
		vim.api.nvim_set_hl(0, "PMenuSel", {fg="#e7d3fb", bg="#443a54", ctermfg=189, ctermbg=238,  italic = (vim.g.aurora_italic==1), bold= true })
		vim.api.nvim_set_hl(0, "PMenuKind", {fg="#1ABC9C", bg="#443a54", ctermfg=189, ctermbg=238,  italic = (vim.g.aurora_italic==1), bold= true })
		vim.api.nvim_set_hl(0, "PMenuExtra", {fg="#10aef8", bg="#443a54", ctermfg=189, ctermbg=238,  italic = (vim.g.aurora_italic==1), bold= true })
		...
		vim.api.nvim_set_hl(0, "Search", {fg="NONE", bg="#3f4060", ctermfg="NONE", ctermbg=239, sp="#EE82EE", underline = true, italic= true , bold= true })
		...
		vim.api.nvim_set_hl(0, "Keyword", {fg="#c4a2ff",  ctermfg=183,   italic = (vim.g.aurora_italic==1), bold= true })
		...
		vim.api.nvim_set_hl(0, "Error", {fg="#DC143C", bg="NONE", ctermfg=161, ctermbg="NONE", sp="#e7dc8c", undercurl = true, bold= true })
		vim.api.nvim_set_hl(0, "Todo", {fg="#e73c50", bg="#6D3B66", ctermfg=167, ctermbg=242,  underline = true, bold= true })
