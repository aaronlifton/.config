  ...
  keys = {
    {
      ...
      ft = { "markdown", "toml" },
      mode = { "o", "x" },
      function() require("various-textobjs").mdlink("inner") end,
      desc = "Markdown Link",
    },
    {
      "am",
      ft = { "markdown", "toml" },
      mode = { "o", "x" },
      function() require("various-textobjs").mdlink("outer") end,
      desc = "Markdown Link",
    },
    {
      "iC",
      ft = { "markdown",  "neoai-output"},
      mode = { "o", "x" },
    ...
    },
    {
      ...
      ft = { "markdown" },
      mode = { "o", "x" },
      function() require("various-textobjs").mdEmphasis("inner") end,
      desc = "Emphasis",
    },
    {
      "ae",
      ft = { "markdown" },
      mode = { "o", "x" },
      function() require("various-textobjs").mdEmphasis("outer") end,
      desc = "Emphasis",
    },
    -- {
    --   "gd", mode = { "o", "x" }, 
    ...
    -- { "ay", ft = { "python" }, mode = { "o", "x" }, function() require("various-textobjs").pyTripleQuotes("outer") end, desc = "Triple Quotes" },
    {
      ...
      ft = { "css", "scss", "less" },
      mode = { "o", "x" },
      function() require("various-textobjs").cssSelector("inner") end,
      desc = "CSS Selector",
    },
    {
      "aC",
      ft = { "css", "scss", "less" },
      mode = { "o", "x" },
      function() require("various-textobjs").cssSelector("outer") end,
      desc = "CSS Selector",
    },
    {
      "iK",
    ...
    },
    {
      ...
      ft = { "css", "scss", "less" },
      mode = { "o", "x" },
      function() require("various-textobjs").cssColor("inner") end,
      desc = "CSS Color",
    },
    {
      "a#",
      ft = { "css", "scss", "less" },
      mode = { "o", "x" },
      function() require("various-textobjs").cssColor("outer") end,
      desc = "CSS Color",
    },
    {
      "iP",
      ft = { "sh" },
      mode = { "o", "x" },
      function() require("various-textobjs").shellPipe("inner") end,
      desc = "Pipe",
    },
    {
      "aP",
      ft = { "sh" },
      mode = { "o", "x" },
      function() require("various-textobjs").shellPipe("outer") end,
      desc = "Pipe",
    },
    {
      "iH",
      ft = { "html, xml, css, scss, less", "astro" },
      mode = { "o", "x" },
    ...
    -- {
    --   "aK",
    --   ft = { "lua", "typescript", "typescriptreact", "javascript", "javascriptreact", "html" },
    --   mode = { "o", "x" },
    --   function() require("various-textobjs").multiCommentedLines("outer") end,
    --   desc = "Mult-line comment",
    -- },
    {
      "aR",
